...
// mengecek apakah ada inputan kata kunci pencarian ($_POST['btnCari']).
...
// menyimpan kata kunci tersebut dalam variabel $dataKataKunci untuk digunakan pada form.
$dataKataKunci = isset($_POST['txtKataKunci']) ? $_POST['txtKataKunci'] : '';


// mengatur jumlah baris per halaman ($baris) dan menghitung jumlah halaman ($maks) berdasarkan total data dan jumlah baris per halaman.
$baris	= 50;
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel">
					...
					<div class="panel-body no-padding">
						<table class="table table-striped">
							...
							<tbody>
								...
								// menampikan data dalam tabel dengan menggunakan looping while.
								...
								?>
									...
									<tr title="<?php echo $data['nama_tamu']; ?>">
										...
										<td><?php echo $data['tgl_reservasi']; ?></td>
					...
					<!-- menampilkan informasi jumlah data dan navigasi halaman di bagian panel footer. -->
