...
//Memproses input form saat tombol "Simpan" ditekan. Data tamu yang diisi akan disimpan ke dalam database.
if (isset($_POST['simpan'])) {
    ...
    //Mengambil ID tamu terakhir dari database untuk menentukan ID tamu baru.
...
<!-- Memanggil fungsi JavaScript checkAvailability() saat input No.Identitas 
(KTP) kehilangan fokus untuk memeriksa ketersediaan No.Identitas. -->
<script>
...
<div class="main-content">
    <!-- Mengatur tampilan form tambah tamu -->
            ...
            <div class="col-lg-12">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <!-- Menampilkan tombol "Atur Ulang" dan "Simpan" untuk mengatur ulang form dan menyimpan data tamu. -->
