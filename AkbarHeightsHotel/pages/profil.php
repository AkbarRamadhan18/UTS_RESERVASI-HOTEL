					...
					<div class="panel-body">
						...
						<form action="?p=ubah_user" method="post" class="form-horizontal" onsubmit="return confirm('Anda yakin akan merubah data anda ?')">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" name="user" id="texk" class="form-control" value="<?php echo $hasil78['username']; ?>" readonly>
								</div>
							</div>
							<div class="form-group">
								<label for="passl" class="col-sm-2 col-sm-2 control-label text-right">Password Lama</label>
								<div class="col-sm-10">
									<input type="password" id="texk" class="form-control" name="passl" placeholder="Masukan Password lama" required="required" oninvalid="this.setCustomValidity('Silahkan Masukan Password !!!')" oninput="setCustomValidity('')">
								</div>
							</div>
							<div class="form-group">
								<label for="passb" class="col-sm-2 col-sm-2 control-label text-right">Password Baru</label>
								<div class="col-sm-10">
									<input type="password" id="texk" class="form-control" name="passb" placeholder="Masukan password baru">
								</div>
							</div>
