...
// menangani proses penyimpanan data tamu setelah tombol "Simpan" ditekan
if (isset($_POST['simpan'])) {
    ...
    // mengupdate data tamu yang sesuai dalam tabel tamu. Jika pembaruan berhasil, pesan alert akan ditampilkan 
    // dan pengguna akan diarahkan kembali ke halaman "tamu". Jika pembaruan gagal, pesan alert yang berbeda akan ditampilkan.
...
// Mengambil ID tamu dari parameter URL menggunakan $_GET['id']
$id = $_GET['id'];
...
<!-- memeriksa ketersediaan data dengan melakukan permintaan AJAX ke server menggunakan
 nilai dari elemen dengan ID "noid" sebagai parameter dan menampilkan responsnya ke elemen dengan ID "user-availability-status". -->
<script>
            ...
            <div class="col-lg-12">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <!-- Bagian tampilan form untuk mengedit data tamu. -->
