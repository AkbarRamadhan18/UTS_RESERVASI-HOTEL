...
// mengecek apakah terdapat pencarian data. Jika ada, maka akan disusun sub query pencarian berdasarkan kata kunci yang dimasukkan.
$pencarianSQL	= "";
				...
				<div class="panel">
					...
					<div class="panel-body no-padding">
						<table class="table table-striped">
							<thead>
								<!-- Membuatkan tabel untuk data kamar -->
								<tr>
									<th>No Kamar</th>
									<th>Kelas</th>
									<th>Harga</th>
							...
							<tbody>
								<!--  Melakukan query untuk mendapatkan data kamar yang sesuai dengan kriteria pencarian dan batasan data per halaman. -->
								...
								?>
									<!-- Mengatur tampilan data kamar dalam tabel. -->
									<tr>
					...
					<!-- : Menampilkan informasi jumlah total data dan navigasi halaman. -->
