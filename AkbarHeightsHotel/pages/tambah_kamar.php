...
//  Memproses input form saat tombol "Simpan" ditekan. Data kamar yang diisi akan disimpan ke dalam database.
if (isset($_POST['simpan'])) {
    $nk = $_POST['nokamar'];
    $kelas = $_POST['kelas'];
    $harga = $_POST['harga'];

    // Mengambil nomor kamar terakhir dari database untuk menentukan nomor kamar baru.
...
<!-- Memanggil fungsi JavaScript checkAvailability() saat input No.Kamar kehilangan fokus untuk memeriksa ketersediaan No.Kamar. -->
<script>
...
<!-- Mengatur tampilan form tambah kamar -->
            ...
            <div class="col-lg-12">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <!--  Menampilkan tombol "Atur Ulang" dan "Simpan" untuk mengatur ulang form dan menyimpan data kamar. -->
