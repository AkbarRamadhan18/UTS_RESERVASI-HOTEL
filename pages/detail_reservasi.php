...
// mengambil ID reservasi yang dikirim melalui parameter GET.
$id = $_GET['id'];

// mengambil data reservasi dan tamu yang terkait berdasarkan nomor reservasi.
...
<!-- menampilkan form untuk menampilkan detail reservasi. -->
            ...
            <div class="col-md-12">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <!-- menampilkan tabel detail kamar yang terkait dengan reservasi tersebut. -->
                        <form class="form-horizontal" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" onSubmit="return confirm('Anda yakin akan menyimpan data ?')">
                            ...
                            <!-- menampilkan informasi seperti nomor kamar, kelas, harga, 
                            jumlah harga (harga per malam dikali jumlah malam), dan total harga reservasi. -->
                            <div class="form-group">
                                <div class="col-sm-12">
