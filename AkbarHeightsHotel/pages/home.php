...
// Melakukan query untuk menghitung jumlah data reservasi, tamu, kamar, dan total pembayaran.
...
<div class="main-content">
	<div class="container-fluid">
		<!-- Menampilkan judul panel ringkasan data dan periode saat ini. -->
		<div class="panel panel-headline">
			...
			<!-- Menampilkan ringkasan data dalam bentuk metrik. Setiap metrik menampilkan jumlah data dan judul yang sesuai. -->
				...
				<div class="panel">
					...
					<div class="panel-body no-padding">
						<table class="table table-striped">
							...
							<tbody>
								<!-- Melakukan query untuk mendapatkan data kamar.	 -->
								...
								while ($data = $sqlget->fetch(PDO::FETCH_ASSOC)) {
									...
									// Menampilkan data kamar dalam tabel. Setiap baris menampilkan informasi 
									// no. kamar, kelas, harga, status kamar, dan keterangan
									echo "<tr>
												<td>$data[no_kamar]</td>
												<td>$data[kelas]</td>
