...
// memasukkan file konfigurasi dan membuat objek koneksi ke database menggunakan kelas Connection.
require_once('../config/config.php');

$connection = new Connection();
$conn = $connection->getConnection();

// mengambil ID reservasi dari URL menggunakan variabel $_GET['id'].
$id = $_GET['id'];

// mengambil data reservasi dan informasi tamu terkait berdasarkan ID reservasi.
...
<body>
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-sm-5">
        ...
        <!-- menampilkan informasi reservasi, termasuk nomor reservasi, 
        tanggal reservasi, tanggal check-in, tanggal check-out, lama menginap, jumlah kamar, dan informasi tamu. -->
    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        ...
        <table class="table table-bordered">
          ...
          //   <!-- menampilkan tabel detail kamar yang dipesan, 
          // termasuk nomor kamar, kelas kamar, harga per malam, dan jumlah harga untuk lama menginap yang ditentukan. -->
        ...
        <!-- menampilkan tanda tangan kasir. -->
  ...
  <!-- melakukan fungsi print setelah halaman selesai dimuat. -->
