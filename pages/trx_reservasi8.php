...
// Melakukan pengaturan koneksi database dan menginisialisasi objek koneksi.
require_once('config/config.php');
$connection = new Connection();
$conn = $connection->getConnection();

// Mengambil nilai dari input form "dari" dan "sampai", dan melakukan konversi tanggal ke format yang sesuai.
$dari1 = $_POST['dari'];
...
// <!--  Membuat objek DateTime untuk tanggal "dari" dan "sampai", dan menghitung selisih hari antara kedua tanggal tersebut. -->
...
<script language="JavaScript">
  // Membuat fungsi JavaScript checkChoice() yang digunakan untuk menghitung jumlah checkbox yang diceklis.
...
<!-- Membuat fungsi JavaScript isChecked() untuk mengaktifkan atau menonaktifkan tombol "Pilih Kamar" berdasarkan jumlah checkbox yang diceklis. -->
    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        <table class="table table-bordered">
          <!-- Menampilkan informasi tanggal yang akan ditampilkan pada tabel. -->
          <tr align="center">
      ...
      <!-- Membuat tabel yang menampilkan daftar kamar beserta detailnya, termasuk checkbox untuk memilih kamar. -->
      <div class="col-sm-12">
        <div class="panel">
          <form name="myform" method="post" action="?p=trx_confirm">
            ...
            <table class="table table-bordered">
              ...
              // Mengambil nilai jumlah hari, tanggal "dari", dan tanggal "sampai" untuk dikirimkan ke halaman "trx_confirm" menggunakan form.
              ...
              while ($data = $sql1->fetch(PDO::FETCH_ASSOC)) {
                ...
                // Menampilkan tabel dengan daftar kamar beserta tombol untuk memilih kamar.
