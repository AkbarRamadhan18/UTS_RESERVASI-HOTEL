...
// emasukkan file konfigurasi dan function yang diperlukan, serta membuat objek koneksi ke database menggunakan kelas Connection.
...
<body>
  <?php
  // memeriksa apakah tombol dengan nama "btntanggal" diklik. 
  // Jika ya, maka kita melakukan proses untuk mencetak laporan berdasarkan rentang tanggal yang dipilih oleh pengguna.
  if (isset($_POST['btntanggal'])) {
    ...
    //  query SQL untuk menghitung jumlah reservasi dalam rentang tanggal dan jumlah total pembayaran dalam rentang tanggal tersebut.
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <strong style="font-size:20px"> LAPORAN DATA TAMU <br> AKBAR HEIGHTS HOTEL</strong><br>

        </div>
        <div class="col-sm-5">
          <br><br>

          <!-- menampilkan informasi priode, jumlah tamu, dan tabel data tamu dalam rentang tanggal. -->
          <table class="table table-bordered">

            <!-- mengambil nilai dari input "bulan" dan "tahun" untuk menentukan priode bulan dan tahun. -->
            <tr>
      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <table class="table table-bordered">
            ...
            // menampilkan informasi priode, jumlah tamu, dan tabel data tamu dalam priode bulan dan tahun.
